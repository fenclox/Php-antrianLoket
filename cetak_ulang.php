            ...
            <div class="col-md-5">
                ...
                <form method="" action="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                        <input name="nama" type="text" class="form-control" onkeyup="isi_otomatis()" id="nama" value="" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row" id="frm_kamar">
                        <label for="" class="col-sm-3 col-form-label">Kamar</label>
                        <div class="col-sm-6">
                            <select class="custom-select" onkeyup="isi_otomatis()" id="kamar" name="kamar" disabled>
                        ...
                        <div class="col-sm-3">
                            <input name="no_bed" type="text" class="form-control" id="no_bed" value="" placeholder="No. Bed" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
